    ...
    return (
        <div className="min-h-screen h-screen w-full" style={{ background: `linear-gradient(120deg, rgba(2,0,36,1) 0%, rgba(29,0,15,1) 100%)` }}>
            ...
            <div className="flex flex-col justify-center items-center w-full h-full">
                <h1 className="text-5xl font-bold text-white mb-4">waitlist</h1>
                <p className="w-1/2 text-lg text-center">You are currently in the waitlist, check back in a few days to see if you have been accepted!</p>
            </div>
        </div>
    )
}
